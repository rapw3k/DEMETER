...
According to the specification, NGSI-LD information model separates semantic referencing, used in the classical sense of the Semantic Web, from the actual structural description: 
...
Tools exist [linlk?], but are not completely documented, to derive NSGI-LD context documents from NSGI data schemas (**NSGI data models are just schemas, rather than semantic models. **)
